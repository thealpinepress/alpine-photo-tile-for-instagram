...
?>
  ...
  public function MenuDisplayCallback($options, $option, $fieldname, $fieldid)
  {
    ...
    ?>
      ...
      <p><?php _e("Below are two different methods for adding users to the Alpine Photo Tile for Social plugin. Try Method One first. If it does not work, try Method Two. Please <a href='http://wordpress.org/support/plugin/alpine-photo-tile-for-instagram'>let me know</a> if these directions become outdated."); ?>
      <?php
                                                                                                  }
